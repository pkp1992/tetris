...
function startGame() {
  ...
  function create() {
    ...
    figureBody.map(el => el.classList.add("figure"));
  }
  ...
  function move() {
    ...
    if (moveFlag) {
      figureBody.map(el => el.classList.remove("figure"));
      figureBody = [
        document.querySelector(
      ...
      figureBody.map(el => el.classList.remove("figure"));
      figureBody.map(el => el.classList.add("set"));
      for (let i = 1; i < 15; i++) {
        let count = 0;
        for (let k = 1; k < 11; k++) {
          if (
            ...
            if (count == 10) {
              ...
              for (let s = 0; s < set.length; s++) {
                ...
                if (setCoordinates[1] > i) {
                  ...
                  newSet.push(
                    document.querySelector(
                      `[posX="${setCoordinates[0]}"][posY="${setCoordinates[1] -
                        1}"]`
                    )
                  );
                }
